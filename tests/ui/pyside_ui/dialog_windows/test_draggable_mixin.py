...
from src.ui.pyside_ui.dialog_windows.draggable_window.draggable_mixin import (
    DraggableMixin,
)
...
def test_init_sets_defaults(mixin: DraggableMixin) -> None:
    assert mixin._drag_active is False
    assert mixin._drag_position == QPoint()


def test_can_drag_default_true(mixin: DraggableMixin) -> None:
    assert mixin._can_drag() is True


def test_handle_mouse_press_wrong_button_returns_false(
...
def test_handle_mouse_press_cannot_drag_returns_false(
    mixin: DraggableMixin,
) -> None:
...
def test_handle_mouse_press_with_system_move_success(
    mixin: DraggableMixin,
) -> None:
    widget = MagicMock()
...
def test_handle_mouse_press_no_window_handle_sets_drag_active(
    mixin: DraggableMixin,
) -> None:
    widget = MagicMock()
...
def test_handle_mouse_press_system_move_fails_sets_drag_active(
    mixin: DraggableMixin,
) -> None:
    widget = MagicMock()
...
def test_handle_mouse_move_active_and_left_button_moves_widget(
    mixin: DraggableMixin,
) -> None:
...
def test_handle_mouse_move_not_active_returns_false(
    mixin: DraggableMixin,
) -> None:
...
def test_handle_mouse_move_active_but_no_left_button_returns_false(
    mixin: DraggableMixin,
) -> None:
    mixin._drag_active = True
    widget = MagicMock()
...
def test_handle_mouse_release_left_button_resets_drag_active(
    mixin: DraggableMixin,
) -> None:
    mixin._drag_active = True
    event = make_mouse_event(
...
def test_handle_mouse_release_other_button_returns_false(
    mixin: DraggableMixin,
) -> None:
    mixin._drag_active = True
    event = make_mouse_event(
